...
const html = ** **<div class="tour-card">** **<img src="${tour.img}" alt="${tour.title}">** **<div class="tour-card-body">** **<h3>${tour.title}</h3>** **<p>${tour.desc}</p>** **<p style="color:#ff5a00; font-weight:bold; font-size:1.2rem;">${tour.price}</p>** **<button class="submit-btn" style="padding:8px; margin-top:10px;" onclick="sendInquiry('${tour.title}')">Enquire Now</button>** **</div>** **</div>;
